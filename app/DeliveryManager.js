...
const blank=()=>({title:'',kind:'mcq',source_id:'',instructions:'',center_id:'',open_at:'',close_at:'',duration_min:60,no_time_limit:false,attempts_allowed:1,unlimited_attempts:false,pass_mark:50,shuffle_questions:true,shuffle_options:false,allow_back:true,show_score:false,show_answers:false,access_code:''});
 ...
 {form?<form className="delivery-paper delivery-form" onSubmit={create}><h2>สร้างรอบสอบใหม่</h2>
  ...
  <fieldset disabled={busy} style={{border:0,padding:0,margin:0}} onChangeCapture={()=>{}}>
   ...
   <div hidden={ftab!=='after'}>
    ...
    <label className="delivery-check"><input type="checkbox" checked={form.show_answers} onChange={e=>set('show_answers',e.target.checked)}/>เปิดเฉลยหลังส่ง / ตรวจเสร็จ</label>
